...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "settings.engines.funasrNote": "Runs a local Python service with 2-pass correction (streaming + offline recheck). Requires a one-time dependency install on first use.",
    ...
    private static let zh: [String: String] = [
        ...
        "settings.engines.funasrNote": "运行本地 Python 服务，支持二次复核（流式出字 + 离线复核修正）。首次使用需要安装一次依赖。",
